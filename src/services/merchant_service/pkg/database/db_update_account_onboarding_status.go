...
func (db *Db) UpdateAccountOnboardingStatus(ctx context.Context, id uint64, state merchant_service_proto_v1.MerchantAccountState) (
...
func (db *Db) updateMerchantAccountOnboardingStatusTxFunc(id uint64, status merchant_service_proto_v1.MerchantAccountState) core_database.CmplxTx {
