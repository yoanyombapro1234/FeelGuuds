...
authentication_service is a microservice made with Go
...
```console
$ helm repo add service https://yoanyombapro1234.github.io/FeelGuuds/src/services/authentication_service

$ helm upgrade -i my-release authentication_service/authentication_service
```

The command deploys authentication_service on the Kubernetes cluster in the default namespace.
...
`image.repository` | `FeelGuuds/authentication_service` | Image repository
...
`service.grpcService` | `authentication_service` | gPRC service name
...
```console
$ helm install my-release authentication_service/authentication_service \
