...
```bash
kubectl apply -k github.com/yoanyombapro1234/FeelGuuds/src/services/cart_service/kustomize
```

Docker:

```bash
docker run -dp 9898:9898 yoanyombapro1234/FeelGuuds/src/services/cart_service
```
