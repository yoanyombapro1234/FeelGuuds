# FeelGuuds Shipping Service - (Spartan)

[![e2e](https://github.com/yoanyombapro1234/FeelGuuds/src/services/shipping_service/workflows/e2e/badge.svg)](https://github.com/yoanyombapro1234/FeelGuuds/src/services/shipping_service/blob/master/.github/workflows/e2e.yml)
[![test](https://github.com/yoanyombapro1234/FeelGuuds/src/services/shipping_service/workflows/test/badge.svg)](https://github.com/yoanyombapro1234/FeelGuuds/src/services/shipping_service/blob/master/.github/workflows/test.yml)
[![cve-scan](https://github.com/yoanyombapro1234/FeelGuuds/src/services/shipping_service/workflows/cve-scan/badge.svg)](https://github.com/yoanyombapro1234/FeelGuuds/src/services/shipping_service/blob/master/.github/workflows/cve-scan.yml)
[![Go Report Card](https://goreportcard.com/badge/github.com/yoanyombapro1234/FeelGuuds/src/services/shipping_service)](https://goreportcard.com/report/github.com/yoanyombapro1234/FeelGuuds/src/services/shipping_service)
[![Docker Pulls](https://img.shields.io/docker/pulls/yoanyombapro1234/FeelGuuds/src/services/shipping_service)](https://hub.docker.com/r/yoanyombapro1234/FeelGuuds/src/services/shipping_service)
...
```bash
kubectl apply -k github.com/yoanyombapro1234/FeelGuuds/src/services/shipping_service/kustomize
```

Docker:

```bash
docker run -dp 9898:9898 yoanyombapro1234/FeelGuuds/src/services/shipping_service
```
