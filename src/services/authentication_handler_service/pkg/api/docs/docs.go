...
var doc = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "Source Code",
            "url": "https://github.com/yoanyombapro1234/FeelGuuds/src/services/authentication_handler_service"
        },
        "license": {
            "name": "MIT License",
            "url": "https://github.com/yoanyombapro1234/FeelGuuds/src/services/authentication_handler_service/blob/master/LICENSE"
        },
        "version": "{{.Version}}"
    },
    "host": "{{.Host}}",
